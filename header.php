...
<!--[if (gte IE 9)|!(IE)]><!--><html class="no-js desktop <?php echo $class ?>" <?php language_attributes();?>><!--<![endif]-->
	<head>
		...
		<link rel="stylesheet" href="/wp-content/themes/halfcreative/styles/parrot.css" type="text/css" media="">
		<script type="text/javascript" src="/wp-content/themes/halfcreative/js/parrot.js"></script>
