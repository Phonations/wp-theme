...
<section class="contact" id="<?php $content->slug(); ?>">
	<div class="inner">
		...
		<p class="lead"><?php echo __($contact->subtitle); ?></p>
		<?php endif; ?>
			...
			<div class="col1">
				<form name="htmlform" method="post" class="peThemeContactForm">
					<div class="control-group">
						<label><?php e__pe("Name"); ?><span class="required">*</span></label>
						<input type="text" name="author" class="required" placeholder="<?php e__pe("Your lovely Name"); ?>" required />
					</div>
					<div class="control-group">
						<label>Email<span class="required">*</span></label>
						<input type="email" name="email" class="required" placeholder="Email" data-validation="email" required />
					</div>
					<div class="control-group">
